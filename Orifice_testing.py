...
inlet = pressure_inlet.PressureInlet(PS, UnitValue.create_unit("in", 0.25), "N2", UnitValue.create_unit("psig", 80), UnitValue.create_unit("K", 280.7), UnitValue.create_unit("m/s", 150), "pressure_inlet")
p = pipe.Pipe(PS, UnitValue.create_unit('in', 0.25), "N2", UnitValue.create_unit('in', 25))
orifice = critical_orifice.CriticalOrifice(PS, UnitValue.create_unit("in",0.25), UnitValue.create_unit("in",0.25), "N2", Cd=0.86)
