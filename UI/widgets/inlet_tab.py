...
class InletTab(ComponentTab):
    def __init__(self, master: CTkFrame, OverarchingMaster: CTkFrame, component: PressureInlet, **kwargs):
        ...
        self.type_opt = CTkOptionMenu(self, font=("Arial", 14), values=["Pressure Inlet"])
    ...
    def __set(self) -> None:
        ...
        self.component.T = self.temperature.unit
