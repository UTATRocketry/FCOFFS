...
class PressureOutletTab(ComponentTab):
    def __init__(self, master: CTkFrame, OverarchingMaster: CTkFrame, component: PressureOutlet, **kwargs):
        ...
        self.pressure_lbl = CTkLabel(self, text="Outlet Pressure: ", font=("Arial", 14))
    ...
    def __set(self) -> None:
        ...
        self.component.rho = Fluid.Fluid.density(self.fluid_opt.get(), self.component.parent_system.ref_T, self.pressure.unit.convert_base_metric())
