...
outlet = pressure_outlet.PressureOutlet(PS, diameter=UnitValue("IMPERIAL", "DISTANCE", "in", 0.8), fluid="N2O", name="Outlet", pressure=UnitValue("IMPERIAL", "PRESSURE", "psi", 775))
