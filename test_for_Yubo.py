...
pipe1 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('inch', 6), name="Pipe 1")
reg = pressure_regulator.PressureRegulator(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), "N2", os.path.join(os.getcwd(), "DOCS", "Components", "Pressure Regulator", "Regulator Curves", "KPF.csv"), UnitValue.create_unit("psi", 800))
pipe2 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('ft', 1), name="Pipe 2")
diffuser1= pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.25), "N2", UnitValue.create_unit('inch', 0.5), name="area change 1")
...
diffuser2 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.25), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('inch', 0.5), name="area change 2")
pipe3 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('ft', 1), name="pipe 3")
bend1 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('inch', 2), name="bend 1")
pipe4 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('ft', 1), name="pipe 4")
bend2 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('inch', 2), name="bend 2")
outlet = pressure_outlet.PressureOutlet(TS.quasi_steady_solver, UnitValue.create_unit('inch', 0.152), "N2", UnitValue.create_unit('psi', 700))
