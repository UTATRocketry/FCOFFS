...
inlet = pressure_tank_inlet.PressurantTank(TS.quasi_steady_solver, UnitValue.create_unit("inch", 0.25), "N2", UnitValue.create_unit("psig", 3000), UnitValue.create_unit("K", 295), UnitValue.create_unit("L", 1.5), UnitValue.create_unit("m/s", 50))
...
out = pressure_outlet.PressureOutlet(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), "N2", UnitValue.create_unit("psig", 1000))
