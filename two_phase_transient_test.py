...
inlet = pressure_tank_inlet.PressurantTank(TS.quasi_steady_solver, UnitValue.create_unit("inch", 0.25), "N2", UnitValue.create_unit("psi", 750), UnitValue.create_unit("C", 20), UnitValue.create_unit("m^3", 0.1), UnitValue.create_unit("m/s", 10))
p = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), "N2", UnitValue.create_unit("m", 1.5)) 
tp_tank = two_phase_tank.TwoPhaseTank(TS.quasi_steady_solver, UnitValue.create_unit("inch", 0.25), UnitValue.create_unit("inch", 0.25), "N2", "C2H6O", UnitValue.create_unit("kg", 4), UnitValue.create_unit("C", 20), UnitValue.create_unit("m^3", 0.5), UnitValue.create_unit("m", 0.2))
p2 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), "C2H6O", UnitValue.create_unit("m", 0.4))
venturri = cavitating_venturi.CavitatingVenturi(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), UnitValue.create_unit("in", 0.25), UnitValue.create_unit("in", 0.01), "C2H6O")
p3 = pipe.Pipe(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), "C2H6O", UnitValue.create_unit("m", 0.4))
out = pressure_outlet.PressureOutlet(TS.quasi_steady_solver, UnitValue.create_unit("in", 0.25), "C2H6O", UnitValue.create_unit("psi", 15))
...
TS.Output.show_tree()
TS.Output.add_probes([(inlet, "p"), (interface2, "mdot"), (interface3, "mdot"), (inlet, "mass"), (interface4, "mdot"), (interface4, "p")]) #
