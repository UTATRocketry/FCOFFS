...
inlet = pressure_inlet.PressureInlet(PS, UnitValue.create_unit("in", 0.25), "C2H6O", UnitValue.create_unit("psi", 650), UnitValue.create_unit("c",25), UnitValue.create_unit("m/s", 5), "pressure_inlet")
p = pipe.Pipe(PS, UnitValue.create_unit("in", 0.25), "N2", UnitValue.create_unit("m", 0.5))
