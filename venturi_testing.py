...
inlet = pressure_inlet.PressureInlet(PS, UnitValue.create_unit("in", 0.25), fluid, UnitValue.create_unit("psi", 800), UnitValue.create_unit("c",25), UnitValue.create_unit("m/s", 0.5), "pressure_inlet")
p = pipe.Pipe(PS, UnitValue.create_unit("in", 0.25), fluid, UnitValue.create_unit("ft", 2))
...
#tube = pipe.Pipe(PS, UnitValue.create_unit("in", 0.25), fluid, UnitValue.create_unit("in", 10))
#injector_manifold = injector.Injector(PS,)
p2 = pipe.Pipe(PS, UnitValue.create_unit("in", 0.25), fluid, UnitValue.create_unit("m", 0.5))
outlet = pressure_outlet.PressureOutlet(PS, UnitValue.create_unit("in",0.25) , fluid, UnitValue.create_unit("psi", 300), "pressure_outlet")
...
PS.initialize([inlet, p, venturi, p2, outlet])
